...
namespace LibraryService.Migrations
{
    ...
    [Migration("20230910164656_addedBookAuthorEntityAndRelation")]
    partial class addedBookAuthorEntityAndRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryService.Persistence.BookAuthor", b =>
                {
                    b.HasOne("LibraryService.Persistence.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryService.Persistence.Book", null)
                        .WithMany()
